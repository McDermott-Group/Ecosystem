...
class nViewer:
	...
	def __init__(self, parent = None):
		...
		lake218.addParameter("Sensor 1", "get_single_temperature", 1)
		lake218.addParameter("Sensor 2", "get_single_temperature", 2)
		lake218.addParameter("Sensor 3", "get_single_temperature", 3)
		lake218.addParameter("Sensor 4", "get_single_temperature", 4)
		lake218.addParameter("Sensor 5", "get_single_temperature", 5)
		lake218.addParameter("Sensor 6", "get_single_temperature", 6)
		lake218.addParameter("Sensor 7", "get_single_temperature", 7)
		lake218.addParameter("Sensor 8", "get_single_temperature", 8)
		lake218.addPlot()
