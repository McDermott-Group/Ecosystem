...
class nViewer:
    ...
    def __init__(self, parent=None):
        ...
        localTemp.addParameter(
            "Outside Temperature", "temperature", None, log=True, significant_figures=1
        )
        ...
        self.gui.addWidget(
            ssc.MStartStopCooldownWidget(
                "C:\\Users\\Noah\\Documents\\College\\McDermott\\DatachestRoot\\testBigButton\\cooldown",
        ...
        directInput = temp.addAnchor(
            name="avg", type="input", terminate=True, precision=2
        )

        virtdev = MVirtualDevice(
            "Test Node", yLabel="Test Node Y Label", units="Test Units"
        )
