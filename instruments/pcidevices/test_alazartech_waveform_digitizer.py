...
def test_ats_configuration(
    ...
    print(
        (
            "There are %d samples per channel, %d bits per sample."
    ...
    print(
        (
            "Minimum memory required: %d bytes, which is about %.2f MB."
