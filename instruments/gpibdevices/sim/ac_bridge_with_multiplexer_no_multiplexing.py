...
class NRuoxServer(LabradServer):
    ...
    def startTakingTemps(self, addrs):
        ...
        # To turn multiplexing on, set to True. To turn off, set to False.
        multiplexing_on = False
        if multiplexing_on:
            l_chan = 1
            chan_add = 1
        else:
        ...
        self.allDeviceChans[addrs]["currentChanIndex"] += chan_add
